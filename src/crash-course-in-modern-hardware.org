...
[[../images/crash-course-in-modern-hardware-0.png]]

[[../images/crash-course-in-modern-hardware-1.png]]

增加少量的SRAM就可以收到奇效， 记得把inst/data分开，L1(~2-3cycles)/L2(~10cycles)延迟主要取决于和CPU之间的距离以及光速。

[[../images/crash-course-in-modern-hardware-2.png]]
...
[[../images/crash-course-in-modern-hardware-3.png]]

Code的确也没啥考虑的，主要是考虑Data尤其是data layout/memory layout.  pointer越多cache miss就越多，性能通常也就越差。

[[../images/crash-course-in-modern-hardware-4.png]]
...
[[../images/crash-course-in-modern-hardware-5.png]]