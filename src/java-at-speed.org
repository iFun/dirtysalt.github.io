...
[[../images/java-at-speed-azul-prod.png]]

----------

Falcon利用LLVM可以针对运行机器生成更好的指令代码

[[../images/java-at-speed-falcon.png]]

----------

JIT可以利用运行时信息生成静态编译器做不到的优化，尤其是在某个分支预测执行上，因为JIT可以根据之前运行时收集到的信息，生成更加利于运行期间的指令代码。

[[../images/java-at-speed-jit0.png]]

[[../images/java-at-speed-jit1.png]]
...
[[../images/java-at-speed-jit3.png]]

[[../images/java-at-speed-jit4.png]]
...
[[../images/java-at-speed-jit5.png]]

[[../images/java-at-speed-jit6.png]]