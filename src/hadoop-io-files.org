...
[[../images/hdfs-sequence-file-format.png]]
...
[[../images/hdfs-sequence-file-header.png]]

其中metadata部分可以存储这个文件的一些元信息，存储格式也非常简单。key和value只是允许Text格式，并且在创建的时候就需要指定

[[../images/hdfs-sequence-file-metadata.png]]

至于里面的record/block存储格式如下

[[../images/hdfs-sequence-file-record.png]] [[../images/hdfs-sequence-file-block.png]]
...
[[../images/hdfs-mapfile-index-data-bloom.png]]
