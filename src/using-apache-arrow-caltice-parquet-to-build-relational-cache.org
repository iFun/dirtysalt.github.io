...
[[../images/using-apache-arrow-caltice-parquet-to-build-relational-cache-0.png]]
...
[[../images/using-apache-arrow-caltice-parquet-to-build-relational-cache-1.png]]

在刷新MV上可以选择合适的顺序进行刷新"Refresh Graph". Dremio底层使用Iceberg格式，是不是也是因为这个容易用来维护MV，这样实现上不用重写物化视图对应的文件。

[[../images/using-apache-arrow-caltice-parquet-to-build-relational-cache-2.png]]